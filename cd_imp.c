...
/**
 * _cd_dot - changes to the parent directory
 *
...
/**
 * _cd_to - changes to the directory given
 * by the user
 *
...
/**
 * _cd_previous - changes to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
...
/**
 * _cd_to_home - changes to the home directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
